...
handler = RotatingFileHandler(
    "/var/log/vote_bot/gbot2.log", maxBytes=10*1024*1024, backupCount=5
)
...
def stop_ec2_instance():
    ...
    send_sns_notification(f"Vote Bot(gbot2) - Shutting Down", f"EC2 instance {instance_id} is shutting down due to server issues.")
