...
logging.basicConfig(
    filename="/var/log/vote_bot/lbot2.log",  # Store logs in /var/log/vote_bot/
...
handler = RotatingFileHandler(
    "/var/log/vote_bot/lbot2.log", maxBytes=10*1024*1024, backupCount=5
)
...
def create_new_session():
    ...
    session.headers.update({
        ...
        "Referer": "https://momentofglow.shalina.com/contestants/merveidie-lubi/",
...
def stop_ec2_instance():
    ...
    send_sns_notification(f"Vote Bot(lbot2) - Shutting Down", f"EC2 instance {instance_id} is shutting down due to server issues.")
