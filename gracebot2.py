...
logging.basicConfig(
    filename="/var/log/vote_bot/gracebot2.log",  # Store logs in /var/log/vote_bot/
...
handler = RotatingFileHandler(
    "/var/log/vote_bot/gracebot2.log", maxBytes=10*1024*1024, backupCount=5
)
...
def create_new_session():
    ...
    session.headers.update({
        ...
        #"Referer": "https://momentofglow.shalina.com/contestants/mamina-nsimba/",
...
def stop_ec2_instance():
    ...
    send_sns_notification(f"Vote Bot(mbot2) - Shutting Down", f"EC2 instance {instance_id} is shutting down due to server issues.")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if result.get("success"):
                ...
                if "limite de votes" in result["data"]["message"]:
